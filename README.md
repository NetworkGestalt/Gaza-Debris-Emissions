...
1. **[QGIS-Data](https://github.com/NetworkGestalt/Gaza-Debris-Carbon-Emissions/tree/main/QGIS-Data):** GeoPackage databases (.gpkg) containing the spatial datasets used for the project's estimations. To comply with GitHub's 25MB file size limit, some GeoPackages have been split and compressed into separate ZIP files.
...
_Please see the [report](https://www.researchgate.net/publication/383876523_Estimating_Carbon_Emissions_from_Processing_Building_Debris_in_Gaza) for the full list of references_
